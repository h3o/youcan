        ...
        <form method="post" action="<?= url('/stories/' . htmlspecialchars($story['slug'], ENT_QUOTES, 'UTF-8') . '/update') ?>" class="form" id="story-form">
            ...
            <div class="form-group<?= isset($errors['title']) ? ' form-group--error' : '' ?>">
                ...
                <input class="form-group__input form-group__input--title" type="text" id="title" name="title"
                       value="<?= htmlspecialchars($story['title'], ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <select class="form-group__input form-group__select" id="language" name="language">
                    ...
                    <option value="<?= $code ?>" <?= ($story['language'] ?? '') === $code ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <div class="vis-picker">
                    ...
                    <label class="vis-option <?= ($story['visibility'] ?? 'public') === $v ? 'vis-option--active' : '' ?>">
                        <input type="radio" name="visibility" value="<?= $v ?>"
                               <?= ($story['visibility'] ?? 'public') === $v ? 'checked' : '' ?>>
            ...
            <div class="form-group<?= isset($errors['content']) ? ' form-group--error' : '' ?>">
                ...
                <input type="hidden" name="content" id="content-input"
                       value="<?= htmlspecialchars($story['content'], ENT_QUOTES, 'UTF-8') ?>">
