<div class="hero">
    <div class="hero__inner">
        ...
        <?php if (!\App\Core\Auth::check()): ?>
            <a href="/register" class="btn btn--primary btn--large"><?= htmlspecialchars(t('home.start_writing'), ENT_QUOTES, 'UTF-8') ?></a>
        <?php else: ?>
            <a href="/stories/create" class="btn btn--primary btn--large"><?= htmlspecialchars(t('home.write_story'), ENT_QUOTES, 'UTF-8') ?></a>
        <?php endif; ?>
    </div>
</div>
    ...
    <?php if (empty($stories)): ?>
        <div class="empty-state">
            <p><?= htmlspecialchars(t('home.no_stories'), ENT_QUOTES, 'UTF-8') ?>
               <a href="/register"><?= htmlspecialchars(t('home.be_first'), ENT_QUOTES, 'UTF-8') ?></a></p>
        </div>
    <?php else: ?>
            ...
            <article class="story-card">
                <div class="story-card__body">
                    ...
                    <div class="story-card__meta">
                        <a href="/profile/<?= htmlspecialchars($story['username'], ENT_QUOTES, 'UTF-8') ?>" class="story-card__author">
